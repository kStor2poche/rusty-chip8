...
impl Gui {
    ...
    fn ui(&mut self, ctx: &Context) {
        ...
        egui::Window::new("About Rusty Chip8")
            .open(&mut self.about_win_open)
            .show(ctx, |ui| {
                ui.label("A small Chip 8 emulator made with egui and pixels by kStor2poche");
